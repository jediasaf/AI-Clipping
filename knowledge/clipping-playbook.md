...
**What this file is:** what we currently believe about making clips that perform, based on
**our own** performance data.

**What this file is not:** a collection of best practices from the internet, or things that
sound true.

## Rules for this file

1. Every entry carries its **sample size** and the **date** the evidence was gathered.
2. An entry may only be added by the Performance Analyst, after real data exists.
3. When new data contradicts an entry, **revise or retire it**. This is a record of current
   belief, not an archive.
4. N < 5 is anecdotal and does not earn an entry. N 5–20 may be entered as a weak signal,
   clearly marked.

The temptation this file exists to resist: after a clip does well, it is very easy to write
down why. That explanation is usually wrong, and once written down it starts directing
production. An empty playbook is honest. A playbook full of confident guesses is worse than
no playbook, because we would scale our guesses.

---

## Established (N ≥ 20)

_Nothing yet. No clips published._
...
The widely-repeated retention statistics — "50–60% of drop-off in the first 3 seconds",
"65% of 3-second viewers watch 10", "a strong 3-second hook makes a video 2.4x more likely
to hit the For You page", "swiped-away above 40% means your hook failed" — **all trace to
vendor marketing blogs citing each other** (opus.pro, capcut.com, sendshort.ai, clipflip.io
and similar). No platform-official source and no published research was found for any of them.

The directional claim that opening seconds dominate *is* supported, by (2) above. The specific
percentages are not. **Do not put them in a deck, a pitch, or a decision.** We will measure
our own.

Likewise "beginners earn $100–500/mo, top performers $5,000+/mo" — every instance traces to a
competitor vendor blog with no visible dataset. Recorded only as a counterweight to
"$21,000/week" title claims, not as a forecast.

---

## Retired beliefs

_Nothing yet. When an entry is retired, keep it here with the date and the data that killed it
— a belief we held and disproved is worth more than one we never tested._
